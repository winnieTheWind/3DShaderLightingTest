...
public class LocalAssetManager {
    ...
    private static final String COLORCRIMSON = "textures/colorcrimson.png";
    //Models
    private static final String BUNNYMODEL = "models/scenenew.g3db";
    //Shaders
    ...
    public void create() {
        ...
        assets.load(COLORCRIMSON, Texture.class);
        ...
        colorcrimson = assets.get(COLORCRIMSON);
